...
def _esbuild_repo_impl(repository_ctx):
    ...
    repository_ctx.symlink(
        Label("@aspect_rules_esbuild//esbuild/private:launcher.cjs"),
        "launcher.cjs",
    )
    repository_ctx.symlink(
        Label("@aspect_rules_esbuild//esbuild/private:plugins/bazel-sandbox.cjs"),
        "plugins/bazel-sandbox.cjs",
    )
